/**
 * Google Calendar PTO Sync
 * 
 * This Google Apps Script automatically syncs "out of office" events from team members' calendars 
 * to a shared team calendar. It searches for events matching specific keywords (e.g., "PTO", "OOO", "vacation") 
 * and imports them into the team calendar. The script is designed to run on an hourly basis and includes options 
 * to filter direct and indirect group members. It also handles duplicate events and ensures events are only added 
 * if they occur on weekdays.
 * 
 * Author: Google
 * Editor: Chad Ramey
 * Date: August 14, 2024
...
let TEAM_CALENDAR_ID = ''; // Team Calendar ID
...
let GROUP_EMAIL = 'group@domain.com';

let ONLY_DIRECT_MEMBERS = false;

let KEYWORDS = ['pto', 'ooo', 'out of office', 'offline', 'vacation', 'PTO', 'Off', 'off', 'Out of office'];
